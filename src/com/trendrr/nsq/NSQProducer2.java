 ...
 * 
 */
public class NSQProducer2 extends AbstractNSQClient {

	protected static Log log = LogFactory.getLog(NSQProducer2.class);
	 ...
	 * @param poolsize
	 */
	public synchronized NSQProducer2 addAddress(String host, int port, int poolsize) {
